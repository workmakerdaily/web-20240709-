...
// }
// console.log(y); 
// ReferenceError: y is not defined(정의되지 않았다)
...
// let y = 10;
// let y = 20; 
// SyntaxError: Identifier 'y' has already been declared'(이미 선언되어있다)
...
// console.log(y); 
// ReferenceError: Cannot access 'y' before initialization(초기화 전에 접근할 수 없습니다)
// let y = 10;

// console.log(y2); 
// ReferenceError: y2 is not defined(선언자체가 안되었다)
...
// ASSIGNMENT = 20; 
// TypeError: Assignment to constant variable.(상수에 할당했다)

// const INITIAL; 
// SyntaxError: Missing initializer in const declaration(초기화가 안되었다)
