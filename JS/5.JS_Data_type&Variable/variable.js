...
var varVariable = 10;
let letVariable = 10;
const constVariable = 10; // const는 상수이므로 무조건 값이 주어져야함



/*
    변수의 중복 선언 : var 키워드를 사용한 변수 선언 시 중복 선인이 가능
*/
var age = 30;
var age = 20;
...
/*
    var 키워드로 선언된 변수는 불록 레벨 스코프가 아닌 함수 레벨의 스코프를 가짐
    - 함수 레벨 스코프 : 함수 내에서 선언된 변수는 함수 안에서 사용 가능, 함수 밖에선 사용 불가능
    - 블록 레벨 스코프 : 코드 블럭 내에서 선언된 변수는 해당 코드 블럭 내에서만 사용 가능, 코드 블럭 밖에서는 사용 불가능
*/
