...
if (!null) console.log('is null'); // is null
...
console.log(parseFloat('10.34'), typeof parseFloat('10.34')); // 10.34 number
...
*/
console.log(Boolean('문자열'), typeof Boolean('문자열')); // true boolean
