...
*/
console.log(1 + '1'); // 11
console.log('저의 나이는 ' + 20 + '세 입니다.'); // 저의 나이는 20세 입니다.
...
/*
    비교 연산자 : 피연산자의 일치여부 판단 후 값을 반환
    - == : 동등 비교
    - === : 일치 비교
    - != : 부등 비교
    - !== 불일치 비교
*/
// 동등, 부등 비교는 자동 형변환을 수행 후 연산 진행 (데이터타입 영향을 받지않음)
