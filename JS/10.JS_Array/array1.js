...
*/
emptyArray[1] = 10;
console.log(emptyArray, emptyArray[0]); // [ <1 empty item>, 10 ] undefined
...
for(var index = 0; index < fruits.length; index++){
    console.log(fruits[index]); // apple banana cacao
}
...
/*
    - for-in 방식은 index를 사용하여 한번 더 접근을 해야하기 대문에 단순히 읽어들이는 작업만 할 때는 적합하지 않을 수 있음
    - for-of 방식을 사용하여 배열의 요소를 복사해서 직접 사용할 수 있음
*/
for(var item of fruits) {
    console.log(item); // apple banana cacao
}
...
// newFruits 첫번째만 '사과'로 바꾸는 방법 3
// var newFruits = [...fruits];
// newFruits[0] = '사과';

console.log(newFruits, fruits); // [ '사과', 'banana', 'cacao' ] [ 'apple', 'banana', 'cacao' ]
...
*/
console.log(fruits, fruits.length); // [ 'apple', 'banana', 'cacao' ] 3

console.log(fruits.push('mango'), fruits); // 4 [ 'apple', 'banana', 'cacao', 'mango' ]
...
*/
console.log(fruits.pop(), fruits); // mango [ 'apple', 'banana', 'cacao' ]
...
*/
console.log(fruits.shift(), fruits); // apple [ 'banana', 'cacao' ]
...
/*
    ...
    - 배열의 순서를 역전
*/
console.log(fruits.reverse(), fruits); // [ 'cacao', 'banana' ] [ 'cacao', 'banana' ]
...
console.log(fruits, newFruits); // [ 'cacao', 'banana' ] [ 'cacao', 'banana', 'apple', 'mango' ]

console.log('==============================');

/*
    slice(start, end) : 
    - startd에 해당하는 인덱스부터 end에 해당하는 인덱스 앞까지 복사하여 반환
*/
console.log(newFruits.slice(1, 3),newFruits); // [ 'banana', 'apple' ] [ 'cacao', 'banana', 'apple', 'mango' ]
